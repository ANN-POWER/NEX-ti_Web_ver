(() => {
  ...
  const fixedQuestions = [
    ...
    },
    {
      ...
      options: [
        { text: "一起分析局势，输了会复盘", type: ["P"] },
        { text: "不太说话，暗中算身份，最后carry全场", type: ["P", "I"] },
        { text: "引领讨论方向，一呼百应", type: ["L"] },
        { text: "怎么每个人说的都好有道理", type: [] },
    ...
    },
    {
      ...
      options: [
        { text: "直接按头安利各种舞台，快一起投票冲一位！", type: ["E", "L"] },
        { text: "挑最最喜欢的歌放给他听，看他反应再决定安利哪个成员", type: ["P", "S"] },
        { text: "自信开跳！嗯七克嗯七克嗯七克！", type: ["X", "E"] },
